...
If you want to learn movements directly from coordinates, you can use **inverse_kinect.py** and **render_reference.py**, currently it just support a dataset created by [VideoPose3D](https://github.com/facebookresearch/VideoPose3D).
